...
public class MinHeap
    ...
    public void heapify_down() {
        if (size == 0) {
            ...
            int index = 0;
            while ((hasLeftChild(index) && heap[index] > heap[leftChild(index)]) || (hasRightChild(index)
                    && heap[index] > heap[rightChild(index)])) {

                if (hasLeftChild(index) && heap[index] > heap[leftChild(index)]
                ...
                else if (hasRightChild(index) && heap[index] > heap[rightChild(index)]
